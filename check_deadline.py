#Обработка дедлайнов
#Программа корректно получает текущую дату.
#Сравнивает текущую дату с issue_date и определяет, истёк ли дедлайн.
#Рассчитывает разницу в днях между датами и выводит соответствующее сообщение.
