# функция принимает список заметок, ключевое слово, либо статус. Поиск может проходит по одному из параметров, а также по двум сразу
# функция возвращает список заметок со словарями
