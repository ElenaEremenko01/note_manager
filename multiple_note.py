...
def id_note(note_list): # задаем параметры функции, в нее мы будем передавать список
    for i in range(len(note_list)):
        print(f'{i+1}. Имя пользователя: {note_list[i]['Имя пользователя']}')
        print(f'Заголовок заметки: {note_list[i]['Заголовок']}')
        print(f'Описание заметки: {note_list[i]['Содержание']}')
        print(f'Статус заметки: {note_list[i]['Статус']}')
        print(f'Дата создания заметки: {note_list[i]['Дата создания заметки']}')
        print(f'Дата истечения заметки: {note_list[i]['Дата истечения заметки']}')
